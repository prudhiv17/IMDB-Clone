...
function WatchList({ watchList, setWatchList, handleRemoveFromWatchList }) {
  ...
  // Retrieve watchList from localStorage when the component mounts
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    console.log(temp); // This will now correctly log unique genres
  }, [watchList]);
            ...
            <div
              ...
              className={
                currGenre == genre
                  ...
                  : "flex justify-center items-center h-[3rem] w-[9rem] mx-4 bg-gray-400/50 rounded-xl text-white font-bold"
              }
            >
              {genre}
            </div>
